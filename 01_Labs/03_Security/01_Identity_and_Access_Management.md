...
![Initial IAM Users](./images/01-iam-initial-users.png)

### 2. Group Membership Configuration
![Group Memberships](./images/02-iam-group-memberships.png)

### 3. S3 Support EC2 Access Restriction Test
![User 1 Access Denied](./images/03-user1-ec2-access-denied.png)

### 4. EC2 Support Read-Only Enforcement Test
![User 2 Stop Denied](./images/04-user2-ec2-stop-denied.png)

### 5. EC2 Admin Access Verification
![User 3 Admin Access](./images/05-user3-ec2-admin-access.png)
