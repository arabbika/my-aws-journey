...
| :---: | :--- | :--- |
| **1** | CloudFormation Stack Failure Analysis | ![Stack Creation Failure](images/01-cfn-initial-create-failed.png) <br><br> ![Web Server Cloud-Init Log Error](images/02-webserver-cloud-init-error-log.png) |
